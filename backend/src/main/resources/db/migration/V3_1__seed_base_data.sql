-- PharmaTrack base seed (base data required by V4 fournisseur seed)
-- Folded from db/seed/seed_data.sql so a clean Flyway run (V1..V6) succeeds.
-- BCrypt hashes valid for: Admin@123, Pharma@123, Supply@123, Visitor@123.
-- Runs at version 3.1: after all tables exist (V1-V3), before V4 seed.
